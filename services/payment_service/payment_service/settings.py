...
# Security
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-payment-dev-key')
...
# Database
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://payment_user:payment_pass@payment_db:5432/payment_db')
